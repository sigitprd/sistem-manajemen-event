      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <h6 class="d-none d-sm-inline-block text-muted"><span class="fas fa-calendar"> </span> <span id="datetime"></span></h6>
          ...
          <div class="container h-100 text-center">
            <img src="{{ asset('assets3/engineer.png') }}" style="width: 40%; height: 40%">
          </div>
...
document.getElementById("datetime").innerHTML = moment(dt).format('DD MMMM, YYYY');
</script>
