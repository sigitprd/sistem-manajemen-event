...
<head>
  ...
  <title>Super Admin - Events Rejected</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Events Rejected</h1>
          </div>
                        ...
                        <div class="row">
                          <div class="col-2 mx-1 my-1"> 
                            ...
                            <div class="dropdown-menu">
                              <form action="{{ url('/admin_events/rejected/'.$myevent->id.'/destroy') }}" method="post">
                                @method('delete')
                                @csrf
