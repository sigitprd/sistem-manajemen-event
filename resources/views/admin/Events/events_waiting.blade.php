...
<head>
  ...
  <title>Super Admin - Events Waiting</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Events Waiting</h1>
          </div>
                        ...
                        <div class="row">
                          <div class="col-2 mx-1 my-1"> 
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item confirmEvent" href="{{ url('/admin_events/waiting/'.$myevent->id.'/confirm') }}">Confirmed Event</a>
                              <a class="dropdown-item rejectEvent" href="{{ url('/admin_events/waiting/'.$myevent->id.'/reject') }}">Rejected Event</a>
                              <form action="{{ url('/admin_events/waiting/'.$myevent->id.'/destroy') }}" method="post">
                                @method('delete')
                                @csrf
...
$(document).ready(function () {
  ...
  $('.confirmEvent').on('click', function (e) {
    e.preventDefault();
    Swal.fire({
      title: 'Are You sure ?',
      text: "Acc this event ? ticket for this event will be available.",
      icon: 'warning',
      ...
      if (result.value) {
        ...
        $.ajax({
            ...
            success: function(response) {
              Swal.fire('Confirmed!', 'This event has been available.', 'success').then(function(){
                location.reload();
              });
            },
  ...
  $('.rejectEvent').on('click', function (e) {
    ...
    Swal.fire({
      title: 'Are You sure ?',
      text: "Reject this event ? ticket for this event will be not available.",
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      ...
      if (result.value) {
        ...
        $.ajax({
            ...
            success: function(response) {
              Swal.fire('Rejected!', 'This event has been rejected.', 'success').then(function(){
                location.reload();
              });
            },
