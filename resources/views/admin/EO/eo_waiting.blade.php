...
<head>
  ...
  <title>Super Admin - Event Organizer - Waiting</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Event Organizer - Waiting</h1>
          </div>
                ...
                <tbody>
                  @if($eos->isEmpty() == false)
                    ...
                    <tr data-name_eo="{{ $eo->name_eo }}" data-address_eo="{{ $eo->address_eo }}" data-phone_number_eo="{{ $eo->phone_number_eo }}" data-identity_card_eo="{{ $eo->identity_card_eo }}" data-status="{{ $eo->status }}" >
                      ...
                      <td>{{ $eo->name_eo }}</td>
                      <td><p class="badge badge-warning">{{ $eo->status }}</p></td>
                      <td>
                        <div class="row">
                          <div class="col-2 mx-1 my-1"> 
                            ...
                            <div class="dropdown-menu">
                              <a class="dropdown-item confirmEO" href="{{ url('/admin_eo/waiting/'.$eo->id.'/confirm') }}">Confirmed EO</a>
                              <a class="dropdown-item rejectEO" href="{{ url('/admin_eo/waiting/'.$eo->id.'/reject') }}">Rejected EO</a>
                              <form action="{{ url('/admin_eo/waiting/'.$eo->id.'/destroy') }}" method="post">
                                @method('delete')
                                @csrf
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-7" id="statusBadge">
                          :<p id="d_status" class="badge badge-warning"> {{ $eos[0]->status }}</p>
                        </div>
                      </div>
      ...
      if (result.value) {
        ...
        $.ajax({
            ...
            success: function(response) {
              Swal.fire('Confirmed!', 'This EO has been available.', 'success').then(function(){
                location.reload();
              });
            },
