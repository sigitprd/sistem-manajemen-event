...
<head>
  ...
  <title>Super Admin - Event Organizer -Rejected</title>
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Event Organizer - Rejected</h1>
          </div>
                ...
                <tbody>
                  @if($eos->isEmpty() == false)
                    ...
                    <tr data-name_eo="{{ $eo->name_eo }}" data-address_eo="{{ $eo->address_eo }}" data-phone_number_eo="{{ $eo->phone_number_eo }}" data-identity_card_eo="{{ $eo->identity_card_eo }}" data-status="{{ $eo->status }}" >
                      ...
                      <td>{{ $eo->name_eo }}</td>
                      <td><p class="badge badge-danger">{{ $eo->status }}</p></td>
                      <td>
                        <div class="row">
                          <div class="col-2 mx-1 my-1"> 
                            ...
                            <div class="dropdown-menu">
                              <form action="{{ url('/admin_eo/rejected/'.$eo->id.'/destroy') }}" method="post">
                                @method('delete')
                                @csrf
                                <button class="dropdown-item deleteEvent" type="submit" value="submit">Delete EO</button>
                              </form>
                            </div>
                          </div>
                        </div>
                    ...
                    <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-7" id="statusBadge">
                          :<p id="d_status" class="badge badge-danger"> {{ $eos[0]->status }}</p>
                        </div>
                      </div>
