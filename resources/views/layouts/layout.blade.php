  ...
  <div class="container">
    ...
    <nav id="nav-menu-container">
      <ul class="nav-menu">
        ...
        @else
        <li><a class="btn" href="{{ route('history') }}">History Transaction</a></li>
...
$(document).ready(function () {
  $('#checkoutBoxForm').on('submit', function(e) {
      e.preventDefault();

      let data_checkout = $('.ticketcat');
      let data = [];
      ...
      if(data.length > 0)
      {
        ...
        $.ajax({
            ...
            success: function(response) {
              ...
              window.location.href = url + '/' + response.id + '/payment';
