jQuery(document).ready(function ($) {
  ...
  $(document).ready(function() {
              $('#lister').click(function(event){event.preventDefault();$('#productser .item').addClass('list-group-item');});
              $('#grider').click(function(event){event.preventDefault();$('#productser .item').removeClass('list-group-item');$('#productser .item').addClass('grid-group-item');});
          });
